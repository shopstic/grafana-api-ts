...
// Generated from https://raw.githubusercontent.com/grafana/grafana/v9.4.3/public/openapi3.json
/**
...
export interface paths {
  ...
  "/datasources/{datasourceId}/disable-permissions": {
     ...
     */
    post: operations["disablePermissions"];
  };
  "/datasources/{datasourceId}/enable-permissions": {
     ...
     * You need to have a permission with action `datasources.permissions:toggle` and scopes `datasources:*`, `datasources:id:*`, `datasources:id:1` (single data source).
     */
    post: operations["enablePermissions"];
  };
  ...
  "/playlists/{uid}/dashboards": {
    get: operations["getPlaylistDashboards"];
  };
  "/playlists/{uid}/items": {
  ...
  "/teams/{teamId}/groups/{groupId}": {
    delete: operations["removeTeamGroupApi"];
  };
  "/teams/{team_id}": {
...
export interface components {
  schemas: {
    ...
    AddPermissionDTO: {
      builtinRole?: string;
      permission?: components["schemas"]["DsPermissionType"];
      /** Format: int64 */
      teamId?: number;
      /** Format: int64 */
      userId?: number;
    ...
    ConfigDTO: {
      ...
      message?: string;
      name?: string;
      options?: components["schemas"]["ReportOptionsDTO"];
      /** Format: int64 */
      orgId?: number;
      recipients?: string;
      replyTo?: string;
    ...
    CreateDashboardSnapshotCommand: {
      Result?: components["schemas"]["DashboardSnapshot"];
      dashboard: components["schemas"]["Json"];
    ...
    DashboardDTO: {
      dashboard?: components["schemas"]["DashboardReportDTO"];
    ...
    DataSourcePermissionsDTO: {
      ...
      datasourceId?: number;
      enabled?: boolean;
      permissions?: components["schemas"]["DataSourcePermissionRuleDTO"][];
    };
    /**
    ...
    MatchRegexps: { [key: string]: components["schemas"]["Regexp"] };
    /**
    ...
    MigrateQueriesToQueryHistoryCommand: {
      ...
      queries?: components["schemas"]["QueryToMigrate"][];
    };
    ...
    NavbarPreference: {
      savedItems?: components["schemas"]["NavLink"][];
    };
    NewApiKeyResult: {
      /**
       * Format: int64
    ...
    ObjectMatchers: components["schemas"]["Matchers"];
    ...
    SettingsDTO: {
      branding?: components["schemas"]["BrandingOptionsDTO"];
      /** Format: int64 */
      id?: number;
      /** Format: int64 */
      orgId?: number;
    ...
    VictorOpsConfig: {
      api_key?: components["schemas"]["Secret"];
      api_key_file?: components["schemas"]["Secret"];
      api_url?: components["schemas"]["URL"];
  ...
  responses: {
    ...
    dashboardVersionsResponse: {
      content: {
        "application/json": components["schemas"]["DashboardVersionDTO"][];
      };
    };
    /** (empty) */
    ...
    getAllPermissionseResponse: {
      content: {
        "application/json": components["schemas"]["DataSourcePermissionsDTO"];
      };
    };
    /** (empty) */
    getAllRolesResponse: {
    ...
    getCustomPermissionsReportResponse: {
      content: {
        "application/json": components["schemas"]["CustomPermissionsRecordDTO"][];
      };
    };
    /** (empty) */
    ...
    getQueryHistoryMigrationResponse: {
      content: {
        "application/json": components["schemas"]["QueryHistoryMigrationResponse"];
      };
    };
    /** (empty) */
    ...
    trimDashboardResponse: {
      content: {
        "application/json": components["schemas"]["TrimDashboardFullWithMeta"];
      };
    };
    ...
    /** (empty) */
    validateDashboardResponse: unknown;
  };
}
...
export interface operations {
  ...
  addAPIkey: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["AddCommand"];
      };
    };
  };
  deleteAPIkey: {
  ...
  trimDashboard: {
    responses: {
      200: components["responses"]["trimDashboardResponse"];
      401: components["responses"]["unauthorisedError"];
      500: components["responses"]["internalServerError"];
    };
    requestBody: {
      content: {
        "application/json": components["schemas"]["TrimDashboardCommand"];
      };
    };
  };
  /** Will return the dashboard given the dashboard unique identifier (uid). */
  ...
  getAllPermissions: {
    ...
    responses: {
      200: components["responses"]["getAllPermissionseResponse"];
      401: components["responses"]["unauthorisedError"];
      403: components["responses"]["forbiddenError"];
      404: components["responses"]["notFoundError"];
      500: components["responses"]["internalServerError"];
  ...
  addPermission: {
    ...
    responses: {
      200: components["responses"]["addPermissionResponse"];
      401: components["responses"]["unauthorisedError"];
      403: components["responses"]["forbiddenError"];
      404: components["responses"]["notFoundError"];
      500: components["responses"]["internalServerError"];
  ...
  getCustomPermissionsReport: {
    responses: {
      200: components["responses"]["getCustomPermissionsReportResponse"];
      500: components["responses"]["internalServerError"];
    };
  };
  /** You need to have a permission with action `licensing.reports:read`. */
  ...
  getPlaylistDashboards: {
    ...
    responses: {
      200: components["responses"]["getPlaylistDashboardsResponse"];
      401: components["responses"]["unauthorisedError"];
      403: components["responses"]["forbiddenError"];
      404: components["responses"]["notFoundError"];
      500: components["responses"]["internalServerError"];
  ...
  migrateQueries: {
    responses: {
      200: components["responses"]["getQueryHistoryMigrationResponse"];
      400: components["responses"]["badRequestError"];
      401: components["responses"]["unauthorisedError"];
      500: components["responses"]["internalServerError"];
    };
    requestBody: {
      content: {
        "application/json": components["schemas"]["MigrateQueriesToQueryHistoryCommand"];
      };
    };
  };
  /** Adds star to query in query history as specified by the UID. */
  ...
  createReport: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["CreateOrUpdateConfigCmd"];
      };
    };
  };
  /**
  ...
  sendReport: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ReportEmailDTO"];
      };
    };
  };
  /** Please refer to [reports enterprise](#/reports/renderReportPDFs) instead. This will be removed in Grafana 10. */
